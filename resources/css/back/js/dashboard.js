  ...
  $(function() {
    let areaData;
      ...
      if ($("#order-chart").length) {
          ...
          const salesChartCanvas = $("#order-chart").get(0).getContext("2d");
    ...
    if ($("#sales-chart").length) {
        const SalesChartCanvas = $("#sales-chart").get(0).getContext("2d");
        const SalesChart = new Chart(SalesChartCanvas, {
            type: 'bar',
            data: {
    ...
    if ($("#north-america-chart").length) {
      ...
      areaOptions = {
        ...
        const northAmericaChartCanvas = $("#north-america-chart").get(0).getContext("2d");
        const northAmericaChart = new Chart(northAmericaChartCanvas, {
            type: 'doughnut',
            data: areaData,
            options: areaOptions,
