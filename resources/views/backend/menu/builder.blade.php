...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">@lang('Menu Builder')</li>
                    </ol>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <form class="" id="menu-editor" style="display: none;">
                                ...
                                <div>&nbsp;</div>
                                <button class="btn btn-primary" id="editButton"><i class="far fa-save"></i>&nbsp; Edit</button>
                            </form>
                        </div>
                        <div class="offset-2 col-md-6">
                            <textarea class="form-control" placeholder="menu json here" readonly name=""
                                      id="json_textarea" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <div class="dd nestable" id="nestable">
                                <ol class="dd-list">
                                    ...
                                    <!--- Item1 --->
                                    <li class="dd-item" data-id="1" data-name="Home" data-slug="home-slug-1"
                                        data-new="0"
                                        data-deleted="0">
                  ...
                  <i class="fas fa-pen" aria-hidden="true"></i>
                                    ...
                                    <!--- Item2 --->
                                    <li class="dd-item" data-id="2" data-name="About Us" data-slug="about-slug-2"
                  ...
                  <i class="fas fa-pen" aria-hidden="true"></i>
                                    ...
                                    <!--- Item3 --->
                                    <li class="dd-item" data-id="3" data-name="Services" data-slug="services-slug-3"
                                        data-new="0" data-deleted="0">
                  ...
                  <i class="fas fa-pen" aria-hidden="true"></i>
                                        ...
                                        <ol class="dd-list">
                                            <!--- Item4 --->
                                            <li class="dd-item" data-id="4" data-name="UI/UX Design"
                                                data-slug="uiux-slug-4"
                                                data-new="0" data-deleted="0">
                      ...
                      <i class="fas fa-pen" aria-hidden="true"></i>
                                            ...
                                            <!--- Item5 --->
                                            <li class="dd-item" data-id="5" data-name="Web Design"
                                                data-slug="webdesign-slug-5" data-new="0" data-deleted="0">
    ...
    @push('extra-script')
        ...
        <script src="{{ asset('assets/back/js/jquery.nestable.js') }}"></script>
        <script>
            ...
            var updateOutput = function (e) {
                ...
                if (window.JSON) {
                    if (output) {
                        ...
                        let x = window.JSON.stringify(list.nestable('serialize'));
                        console.log(x); //see output here in console.
                        document.getElementById("json_textarea").value = x;
