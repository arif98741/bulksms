...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">@lang('Add Menu')</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="">@lang('Menu Title')</label>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                       <span class="input-group-btn">
                                         <a id="Menu_thumbnail_filemanager" data-input="thumbnail"
                                            data-preview="image_preview" class="btn btn-dark"
                                            style="border-radius: 0px;">
                                           <i class="fa fa-picture-o"></i> @lang('Menu image')
                                         </a>
                                       </span>
    ...
    @push('extra-script')
        ...
        <script>
            ...
            $('#Menu_thumbnail_filemanager').filemanager('image');
