    ...
    <div class="content-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">@lang('Menus') </a></li>
                <li class="breadcrumb-item active" aria-current="page">@lang('Edit Menu')</li>
            </ol>
        </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <form id="categoryFormSubmit" class="forms-sample"
                          action="{{ route('admin.menu.update',$category->id) }}"
