                    ...
                    <div class="widget widget-activity-four">
                        ...
                        <div class="widget-content">
                                ...
                                <div class="timeline-line">
                                    ...
                                    @foreach($logs as $log)
                                        <div class="item-timeline timeline-primary">
                                            ...
                                            <div class="t-text">
                                                <p><span>Updated</span> {{ $log->activity }}</p>
                                            </div>
                                        </div>
                            ...
                            <div class="tm-action-btn">
                                <a href="{{ route('backend.user-activity-log.index') }}" class="btn btn-success"><span>View All</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="widget widget-account-invoice-three">
                        ...
                        <div class="widget-heading">
                            <div class="wallet-usr-info">
                                <div class="usr-name">
                                    <span><img src="{{ asset('backend/assets/img/profile-32.jpg')}}" alt="admin-profile"
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-13.jpg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-7.jpg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-10.jpg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-5.jpg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-4.jpg')}}"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><img
                                                    src="{{ asset('backend/assets/img/profile-11.jpg')}}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-scroll">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{ asset('backend/assets/img/product-headphones.jpg')}}"
                                                    alt="product">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{ asset('backend/assets/img/product-shoes.jpg')}}"
                                                    alt="product">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{ asset('backend/assets/img/product-watch.jpg')}}"
                                                    alt="product">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{ asset('backend/assets/img/product-laptop.jpg')}}"
                                                    alt="product">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name"><img
                                                    src="{{ asset('backend/assets/img/product-camera.jpg')}}"
                                                    alt="product">
